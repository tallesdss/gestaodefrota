                  ...
                  builder: (context, pixConfig, _) {
                    return ListTile(
                      leading: Container(
                        ...
                        child: const Icon(Icons.pix, color: Color(0xFF00BDAE), size: 22),
                      ),
                      title: Text(
                        'Chave PIX Ativa: ${pixConfig.pixKey} (${pixConfig.keyType.label})',
                        style: AppTextStyles.labelLarge.copyWith(fontWeight: FontWeight.bold),
                      ),
                      subtitle: Text(
                        'Beneficiário: ${pixConfig.merchantName} • ${pixConfig.merchantCity}',
